...
const Hero = () => {
  ...
  // Memoized tech stack rendering with adjusted positions
    ...
    () =>
      TECH_STACK.map((tech, index) => (
        <motion.div
          ...
          animate={{ opacity: 1, scale: 1 }} // Changed to animate for immediate render
          transition={{
            duration: 0.3,
          ...
          className={`absolute rounded-xl p-3 shadow-lg backdrop-blur-sm will-change-transform md:max-w-[150px] ${
            index === 0
              ? "top-0 left-0"
              : index === 1
              ? "top-0 right-0"
          ...
          <motion.div
            ...
            <div className="relative w-80 h-80 sm:w-96 sm:h-96 max-w-full">
              <motion.div
                ...
                animate={{ opacity: 1, scale: 1 }} // Changed to animate
